...
import com.example.triviaapp.databinding.FragmentAnswerBinding;
...
public class AnswerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView respuesta= binding.respuestaText;
        Bundle bundle = getArguments();
        String answer = bundle.getString("answer");
        String name= bundle.getString("nombre");
        if(bundle != null){
            if(answer == "correcto"){
                respuesta.setText("! Genial " + name + " !, Ganaste !!");
            } else{
                respuesta.setText("Bueno, te equivocaste " + name + " ,intentalo otra vez");
            }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.intentaBtn.setOnClickListener(new View.OnClickListener() {
            @Override
